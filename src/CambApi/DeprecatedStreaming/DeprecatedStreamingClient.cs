...
public partial class DeprecatedStreamingClient
{
    private RawClient _client;

    internal DeprecatedStreamingClient(RawClient client)
    {
        _client = client;
    }
    ...
    public async Task<Dictionary<string, object?>> StopStreamAsync(
        int streamId,
    ...
    public async Task<GetProbeStreamOut> GetProbeStreamAsync(
        GetProbeStreamV1StreamProbePostRequest request,
        RequestOptions? options = null
    )
    {
        var _query = new Dictionary<string, object>() { };
